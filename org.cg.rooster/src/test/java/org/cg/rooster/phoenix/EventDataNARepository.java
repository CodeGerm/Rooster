...
/**
 * A Data Repository for {@link Event} with auto commit = false
 * @author WZ
 *
 */
public class EventDataNARepository extends PhoenixJdbcDataRepository<Event, Object[]> {
	
	public EventDataNARepository() {
